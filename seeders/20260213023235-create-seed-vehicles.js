...
export default{
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('ref_vehicle_types', [
      { id: 1, name: 'TRUCK CDE', created_at: new Date(), updated_at: new Date() },
      { id: 2, name: 'TRUCK CDD', created_at: new Date(), updated_at: new Date() },
      { id: 3, name: 'WINGBOX', created_at: new Date(), updated_at: new Date() }
    ]);
