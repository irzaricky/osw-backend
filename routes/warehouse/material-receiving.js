...
router.get('/dropdown', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Supervisor Warehouse', 'Warehouse Staff']), async (req, res) => {
...
router.post('/:id/arrived', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.arrived(req);
  helper.sendResponse(res, result);
});

// get progress material receiving
router.get('/:id/progress', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.progress(req);
  helper.sendResponse(res, result);
});

// get detail quantity checking
router.get('/quantity-checking/:mdo_detail_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.quantityCheckingDetail(req);
  helper.sendResponse(res, result);
});

// post scan quantity checking
router.post('/quantity-checking/scan/:mr_item_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
...
router.patch('/quantity-checking/incomplete/:mr_item_label_id/edit', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.editQuantityIncomplete(req);
  helper.sendResponse(res, result);
});

// post submit quantity checking
router.post('/quantity-checking/submit/:mdo_detail_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.submitQuantityChecking(req);
  helper.sendResponse(res, result);
});

// get detail quality checking
router.get('/quality-checking/:mdo_detail_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.qualityCheckingDetail(req);
  helper.sendResponse(res, result);
});

// post scan quality checking
router.post('/quality-checking/scan/:mr_item_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.scanQualityLabel(req);
  helper.sendResponse(res, result);
});

// patch mark quality defect
router.patch('/quality-checking/defect/:mr_item_label_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.markQualityDefect(req);
  helper.sendResponse(res, result);
});

// patch edit quality defect
router.patch('/quality-checking/defect/:mr_item_label_id/edit', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.editQualityDefect(req);
  helper.sendResponse(res, result);
});

// post submit quality checking
router.post('/quality-checking/submit/:mdo_detail_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
  const result = await materialReceivingModule.submitQualityChecking(req);
  helper.sendResponse(res, result);
});

// print part label
router.get('/print-label/:mdo_detail_id', session.sessionChecker, session.permissionChecker(['Superadmin', 'Admin Warehouse', 'Warehouse Staff']), async (req, res) => {
