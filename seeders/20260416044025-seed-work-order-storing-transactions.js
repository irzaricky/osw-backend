export default {
  async up(queryInterface, Sequelize) {
    ...
    const workOrders = [
      { id: 1, wo_number: 'WO-F-260416-001', wo_category: 'Placement', wo_date: new Date(), wo_type_id: 3, warehouse_area_id: 9, wo_status_id: 1, created_by: 1, ...timestamp },
      ...
      { id: 3, wo_number: 'WO-M-260416-001', wo_category: 'Placement', wo_date: new Date(), wo_type_id: 1, warehouse_area_id: 1, wo_status_id: 1, created_by: 1, ...timestamp }
    ];
    ...
    // 5. Seed Part Labels
    const partLabels = [
      { id: 1, label_number: 'VOBKME2025-260416-000001', part_id: 1, ...timestamp },
      { id: 2, label_number: 'VOBKME2025-260416-000002', part_id: 1, ...timestamp },
      { id: 3, label_number: 'VOGRME2025-260416-000003', part_id: 2, ...timestamp },
      { id: 4, label_number: 'ASSY-WHEEL-F-26-260416-000001', part_id: 13, ...timestamp },
      { id: 5, label_number: 'ASSY-WHEEL-F-26-260416-000002', part_id: 13, ...timestamp },
      { id: 6, label_number: 'ASSY-WHEEL-F-26-260416-000003', part_id: 13, ...timestamp },
      { id: 7, label_number: 'PART-TIRE-26-260416-000001', part_id: 41, ...timestamp },
      { id: 8, label_number: 'PART-TIRE-26-260416-000002', part_id: 41, ...timestamp }
    ];
