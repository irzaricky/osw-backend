export default {
  async up(queryInterface, Sequelize) {
    ...
    const jobs = [
      { job_code: 'JOB-INSP-DIM', name: 'Check Frame Dimension', type: 'INSPECTION', standard_time: 2, active: true },
      { job_code: 'JOB-INSP-WELD', name: 'Welding Joint Inspection', type: 'INSPECTION', standard_time: 4, active: true },
      { job_code: 'JOB-ALIGN-FRM', name: 'Frame Alignment Setting', type: 'ASSEMBLY', standard_time: 5, active: true },
      { job_code: 'JOB-INST-BRKT', name: 'Install Frame Bracket', type: 'ASSEMBLY', standard_time: 6, active: true },
      { job_code: 'JOB-QC-FRM', name: 'Final Frame QC', type: 'INSPECTION', standard_time: 3, active: true },
      { job_code: 'JOB-INST-WIRE', name: 'Install Wiring Harness', type: 'ASSEMBLY', standard_time: 6, active: true },
      { job_code: 'JOB-INST-CTRL', name: 'Install Controller Unit', type: 'ASSEMBLY', standard_time: 5, active: true },
      { job_code: 'JOB-INST-MOTOR', name: 'Install Motor Hub', type: 'ASSEMBLY', standard_time: 7, active: true },
      { job_code: 'JOB-INST-BATT', name: 'Install Battery Pack', type: 'ASSEMBLY', standard_time: 6, active: true },
      { job_code: 'JOB-TEST-ELEC', name: 'Electrical Functional Test', type: 'TESTING', standard_time: 5, active: true },
      { job_code: 'JOB-SPRAY-PRM', name: 'Primer Spray', type: 'PAINTING', standard_time: 6, active: true },
      { job_code: 'JOB-OVEN-PRM', name: 'Oven Drying Primer', type: 'OVEN', standard_time: 15, active: true },
      { job_code: 'JOB-QC-PRM', name: 'Primer Quality Check', type: 'INSPECTION', standard_time: 3, active: true },
      { job_code: 'JOB-SPRAY-COL', name: 'Color Spray', type: 'PAINTING', standard_time: 8, active: true },
      { job_code: 'JOB-OVEN-COL', name: 'Oven Drying Color', type: 'OVEN', standard_time: 20, active: true },
      { job_code: 'JOB-QC-COL', name: 'Color Defect Inspection', type: 'INSPECTION', standard_time: 4, active: true },
      { job_code: 'JOB-CLEAN-FNL', name: 'Final Surface Cleaning', type: 'PAINTING', standard_time: 3, active: true },
      { job_code: 'JOB-SPRAY-COAT', name: 'Color Coat Spray', type: 'PAINTING', standard_time: 6, active: true },
      { job_code: 'JOB-OVEN-COAT', name: 'Oven Drying Color Coat', type: 'OVEN', standard_time: 18, active: true },
      { job_code: 'JOB-INSP-THK', name: 'Measure Paint Thickness', type: 'INSPECTION', standard_time: 3, active: true },
      { job_code: 'JOB-INSP-VIS', name: 'Visual Paint Inspection', type: 'INSPECTION', standard_time: 3, active: true },
      { job_code: 'JOB-PACK-ACC', name: 'Accessories Packing', type: 'PACKING', standard_time: 4, active: true },
      { job_code: 'JOB-PACK-WRAP', name: 'Bike Wrapping', type: 'PACKING', standard_time: 5, active: true },
      { job_code: 'JOB-PACK-CART', name: 'Carton Packing', type: 'PACKING', standard_time: 6, active: true },
      { job_code: 'JOB-PACK-LBL', name: 'Labeling & Barcode', type: 'PACKING', standard_time: 2, active: true },
      { job_code: 'JOB-TEST-ROAD', name: 'Road / Dyno Test', type: 'TESTING', standard_time: 8, active: true },
      { job_code: 'JOB-TEST-SAFE', name: 'Electrical Safety Test', type: 'TESTING', standard_time: 5, active: true },
      { job_code: 'JOB-REL-WH', name: 'Release to Warehouse', type: 'SYSTEM', standard_time: 2, active: true },
      
      // Additional derived jobs
      { job_code: 'JOB-CHECK-VIS', name: 'Check Frame Visual Defect', type: 'INSPECTION', standard_time: 2, active: true },
      { job_code: 'JOB-CHECK-STR', name: 'Check Weld Strength', type: 'INSPECTION', standard_time: 2, active: true },
      { job_code: 'JOB-VER-GEO', name: 'Verify Frame Geometry', type: 'INSPECTION', standard_time: 2, active: true },
      { job_code: 'JOB-TRQ-BRKT', name: 'Torque Bracket Bolt', type: 'ASSEMBLY', standard_time: 2, active: true },
      { job_code: 'JOB-RT-WIRE', name: 'Route & Clamp Wiring', type: 'ASSEMBLY', standard_time: 2, active: true },
      { job_code: 'JOB-CN-CTRL', name: 'Connect Controller Wiring', type: 'ASSEMBLY', standard_time: 2, active: true },
      { job_code: 'JOB-CN-MTR', name: 'Motor Wiring Connection', type: 'ASSEMBLY', standard_time: 2, active: true },
      { job_code: 'JOB-SEC-BATT', name: 'Secure Battery Lock', type: 'ASSEMBLY', standard_time: 2, active: true },
      { job_code: 'JOB-ERR-CODE', name: 'Error Code Verification', type: 'TESTING', standard_time: 2, active: true },
      { job_code: 'JOB-INST-WHL', name: 'Install Front & Rear Wheel', type: 'ASSEMBLY', standard_time: 4, active: true },
      { job_code: 'JOB-INST-BRK', name: 'Install Brake System', type: 'ASSEMBLY', standard_time: 4, active: true },
      { job_code: 'JOB-ADJ-BRK', name: 'Brake Adjustment', type: 'ASSEMBLY', standard_time: 3, active: true },
      { job_code: 'JOB-INST-HND', name: 'Install Handlebar', type: 'ASSEMBLY', standard_time: 3, active: true },
      { job_code: 'JOB-ALN-HND', name: 'Handlebar Alignment', type: 'ASSEMBLY', standard_time: 2, active: true },
      { job_code: 'JOB-INST-ACC', name: 'Install Lamp & Accessories', type: 'ASSEMBLY', standard_time: 3, active: true },
      { job_code: 'JOB-CHK-ASSY', name: 'Overall Assembly Check', type: 'INSPECTION', standard_time: 3, active: true },
      { job_code: 'JOB-CHK-TRQ', name: 'Torque Final Check', type: 'INSPECTION', standard_time: 2, active: true },
      { job_code: 'JOB-SIM-ROAD', name: 'Road Test Simulation', type: 'TESTING', standard_time: 5, active: true },
      { job_code: 'JOB-TST-BRK', name: 'Brake & Acceleration Test', type: 'TESTING', standard_time: 3, active: true },
      { job_code: 'JOB-VIS-FIN', name: 'Final Visual Inspection', type: 'INSPECTION', standard_time: 3, active: true },
      { job_code: 'JOB-APP-FUN', name: 'Functional Approval', type: 'INSPECTION', standard_time: 1, active: true },
      { job_code: 'JOB-CLN-UNIT', name: 'Cleaning Unit', type: 'PACKING', standard_time: 2, active: true },
      { job_code: 'JOB-ATT-LBL', name: 'Attach Manual & Label', type: 'PACKING', standard_time: 1, active: true },
      { job_code: 'JOB-PCK-BOX', name: 'Pack E-Bike into Carton', type: 'PACKING', standard_time: 4, active: true },
      { job_code: 'JOB-SEAL-BOX', name: 'Seal & Strap Carton', type: 'PACKING', standard_time: 2, active: true },
      { job_code: 'JOB-MOV-FG', name: 'Move to FG Area', type: 'SYSTEM', standard_time: 2, active: true },
      { job_code: 'JOB-SCN-SN', name: 'Scan Serial Number', type: 'SYSTEM', standard_time: 1, active: true }
    ].map(j => ({
      job_code: j.job_code,
      name: j.name,
